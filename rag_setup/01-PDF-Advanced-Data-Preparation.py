...
if table_exists(f'{catalog}.{db}.documentation'):
  (spark.readStream.table('documentation')
      .withColumn('embedding', get_embedding("content"))
...
# MAGIC %sql
# MAGIC SELECT * FROM pdf_documentation WHERE url like '%.pdf' limit 10
...
vs_index_fullname = f"{catalog}.{db}.pdf_documentation_self_managed_vs_index"
...
question = "What was the engine model and engine manufacturer involved in the incident?"
